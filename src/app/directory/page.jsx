      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          <button
            ...
            className={`border rounded-xl p-1 text-sm font-medium border-grey  mr-2 text-center ${isGOactive ? "text-white bg-kaavi border-none" : "text-black bg-inherit"}`}
          >
            <p>Government Officials</p>
          </button>
          <button
            onClick={handlePMclick}
            className={`border rounded-xl p-1 text-sm font-medium border-grey  mr-2 text-center ${isPMactive ? "text-white bg-kaavi border-none" : "text-black bg-inherit"}`}
          >
            <p>Party members</p>
          </button>
          <button
            onClick={handleOclick}
            className={`border rounded-xl p-1 text-sm font-medium border-grey text-center ${isOactive ? "text-white bg-kaavi border-none" : "text-black bg-inherit"}`}
          >
            <p>Others</p>
          </button>
        </div>
