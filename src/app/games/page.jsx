        ...
        <div className=" grid lg:grid-cols-4 relative z-[0]">
          ...
          <div className="col-span-3 pt-[70px]">
           ...
           <div className="max-w-[500px] flex mx-auto w-fit my-10 items-start justify-evenly bg-[#f8eae3] px-6 py-6 rounded-md cursor-pointer hover:scale-110 hover:drop-shadow-2xl transition-all ">
              <img src="/sudoku.png" alt="sudoku" className="md:w-[150px] w-[100px] my-auto" />
              <div>
                <h1 className="md:text-3xl text-xl font-bold mt-6 mb-1">Sudoku</h1>
            ...
            <div className="max-w-[500px] flex gap-6 mx-auto w-fit my-10 items-start justify-evenly bg-[#f8eae3] px-6 py-6 rounded-md cursor-pointer hover:scale-110 hover:drop-shadow-2xl transition-all ">
              <img src="/quiz.jpg" alt="quiz"  className="md:w-[150px] w-[100px] my-auto" />
              <div>
                <h1 className="md:text-3xl text-xl font-bold mt-6 mb-1">Quiz</h1>
                <h2 className="md:text-lg mb-6">
            ...
            <div className="max-w-[500px] flex gap-6 mx-auto w-fit my-10 items-start justify-evenly bg-[#f8eae3] px-6 py-6 rounded-md cursor-pointer hover:scale-110 hover:drop-shadow-2xl transition-all ">
              <img src="/chess.png" alt="chess"  className="md:w-[150px] w-[100px] my-auto" />
              <div>
                <h1 className="md:text-3xl text-xl font-bold mt-6 mb-1">Chess</h1>
                <h2 className="md:text-lg mb-6">
            ...
            <div className="max-w-[500px] flex gap-6 mx-auto w-fit my-10 items-start justify-evenly bg-[#f8eae3] px-6 py-6 rounded-md cursor-pointer hover:scale-110 hover:drop-shadow-2xl transition-all ">
              <img src="/mario.jpeg" alt="mario"  className="md:w-[150px] w-[100px] my-auto" />
              <div>
                <h1 className="md:text-3xl text-xl font-bold mt-6 mb-1">Super Mario</h1>
                <h2 className="md:text-lg mb-6">
            ...
            <div className="max-w-[500px] flex gap-6 mx-auto w-fit my-10 items-start justify-evenly bg-[#f8eae3] px-6 py-6 rounded-md cursor-pointer hover:scale-110 hover:drop-shadow-2xl transition-all ">
              <img src="/words.png" alt="quiz"  className="md:w-[150px] w-[100px] my-auto" />
              <div>
                <h1 className="md:text-3xl text-xl font-bold mt-6 mb-1">Quiz</h1>
                <h2 className="md:text-lg mb-6">
